...
class HBSHollisDatasourceTest(GeneralRequestAPITestCase):
    ...
    def _get_provider_data(self):
        ...
        return {
                    ...
                    "result_mappings": "title=pnx.display.title,body=pnx.display.description,date_published=pnx.display.creationdate,author=pnx.facets.creatorcontrib,url='https://hollis.harvard.edu/primo-explore/fulldisplay?docid={pnx.control.recordid[0]}&context=L&vid=HVD2',pnx.display.publisher,pnx.display.edition,pnx.display.format,pnx.display.language,pnx.enrichment.classificationlcc,pnx.control.recordid,NO_PAYLOAD",
