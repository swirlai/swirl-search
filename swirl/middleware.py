...
class TokenMiddleware:
    ...
    def __call__(self, request):
        if (request.path == '/swirl/login/' or request.path == '/swirl/oidc_authenticate/' or request.path == '/swirl/microsoft/auth' or '/sapi/' not in request.path) and request.path != '/swirl/logout/':
