...
| Version                     | Date                        | Notes | 
| --------------------------- | --------------------------- | ----- |
| [SWIRL SEARCH 1.4](https://github.com/sidprobstein/swirl-search/releases/tag/v1.4) | 10-9-2022 | [Release Notes](./docs/RELEASE_NOTES_1.4.md) |
| [Docker Image](https://hub.docker.com/r/sidprobstein/swirl-search) | * | [Setup Guide](https://github.com/sidprobstein/swirl-search/wiki/1.-Quick-Start#docker) | 
