...
| Version                     | Date                        | Notes | 
| --------------------------- | --------------------------- | ----- |
| [SWIRL SEARCH 1.5 beta](https://github.com/sidprobstein/swirl-search/releases/tag/v1.5_beta) | 10-30-2022 | [Release Notes](./docs/RELEASE_NOTES_1.5.md) - Recommended for all users! |
