...
SWIRL_DOC_ORIGIN_CHAT_DOMAIN=env('SWIRL_DOC_ORIGIN_CHAT_DOMAIN',default='chat.docs.swirlaiconnect.com')
SWIRL_DOC_ORIGIN_PROTOCOL=env('SWIRL_DOC_ORIGIN_PROTOCOL',default='https')
SWIRL_DOC_ORIGIN_CHAT=SWIRL_DOC_ORIGIN_PROTOCOL + '://' + SWIRL_DOC_ORIGIN_CHAT_DOMAIN
