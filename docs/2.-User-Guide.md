...
* As of Release 1.10, Swirl Metasearch includes example SearchProviders for JetBrains YouTrack Issues and Artciles.
...
* As of Release 2.1, Swirl Metaseaerch includes example SearchProviders for GitHub Code, Commits, Issues, and Pull Requests (public repositories only).
